...
int main()
{
    ...
    RK3_system_time_zero(positions,first_vel, last_vel, int_velocities, 0, theta, l_noise, r_noise,
                            trunc_theta_norm, a_0, b_0, a_bath, b_bath, l_noise, r_noise, l_bath_init_pos, 
                            l_bath_init_vel, r_bath_init_pos, r_bath_init_vel, half_grid_first_vel, half_grid_last_vel);
